...
# Collect all unique feature labels across the database
...
# Convert an item's attributes into a binary feature vector
...
# Rank all items by similarity to user profile and return top n
...
# Search for items by partial title match
